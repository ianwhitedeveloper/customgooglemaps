...
let encodedRelativeURL = encodeURIComponent(window.location.href);
...
.append(
	`<div style="width: 100%; height: 100%">
		<a href="https://www.facebook.com/sharer/sharer.php?u=${encodedRelativeURL}" target="_blank" aria-label="Share on Facebook">
...
.append(
	`<div style="width: 100%; height: 100%">
		<a href="https://twitter.com/intent/tweet?text=Hello%20world ${encodedRelativeURL}" target="_blank" aria-label="Share on Twitter">
